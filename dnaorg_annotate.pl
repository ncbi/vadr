...
my $usage = "\ndnaorg_annotate.pl\n";
$usage .= "\t<list file with all accessions to annotate>\n";
$usage .= "\n"; 
...
$usage .= "\n";
$usage .= " dnaorg_build.pl <refaccn> must have already been run\n";
$usage .= " where <refaccn> is the reference accession.\n";
$usage .= "\n";
$usage .= " BASIC/COMMON OPTIONS:\n";
$usage .= "  -d <s>       : specify output directory is <s> (created with dnaorg_build.pl -d <s>), not <reference accession>\n";
...
my $dir              = undef; # defined if -d enabled
