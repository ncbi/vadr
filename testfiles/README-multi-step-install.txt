...
Step 2. Build binaries with the command below. Make sure you save
or copy the end of the resulting output, specifically the section
beginning with the text 'The final step is to update your environment
variables.' to the end of the output. You will use part of this text
to set your environment variables later.
