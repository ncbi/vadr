# usage: 
# set-vadr-environment-bash.sh <directory where checkout-source.sh and build-binaries.sh were run from>
# 
# for example:
# set-vadr-environment-bash.sh /home/nawrocki/vadr-install
#
