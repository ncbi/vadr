...
gunzip dnaorg-build-directories/flaviviridae-classify-build/flaviviridae-classify-build/flaviviridae-classify-build.dnaorg_classify.hmm.gz
gunzip dnaorg-build-directories/flaviviridae-classify-build/flaviviridae-classify-build/flaviviridae-classify-build.dnaorg_classify.hmm.h3p.gz
echo "------------------------------------------------"
