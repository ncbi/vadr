...
| `--lowsim5sterm <n>`| [*lowsim5s*](#lowsim5s1)                             | LOW_SIMILARITY_START                   | >= 15  | <a name="options-alerts-lowsim5sterm"></a> set length (nt) threshold for alert to `<n>` |
| `--lowsim3sterm <n>`| [*lowsim3s*](#lowsim3s1)                             | LOW_SIMILARITY_END                     | >= 15  | <a name="options-alerts-lowsim3sterm"></a> set length (nt) threshold for alert to `<n>` |
| `--lowsim5fterm <n>`| [*lowsim5f*](#lowsim5f1)                             | LOW_FEATURE_SIMILARITY_START           | >= 15  | <a name="options-alerts-lowsim5fterm"></a> set length (nt) threshold for alert to `<n>` |
| `--lowsim3fterm <n>`| [*lowsim3f*](#lowsim3f1)                             | LOW_FEATURE_SIMILARITY_END             | >= 15  | <a name="options-alerts-lowsim3fterm"></a> set length (nt) threshold for alert to `<n>` |
...
| [*lowsim5s*](#lowsim5s1)  | LOW_SIMILARITY_START            | [`--lowsim5sterm`](#options-alerts-lowsim5sterm) | - | - <a name="lowsim5s2"></a> | 
| [*lowsim3s*](#lowsim3s1)  | LOW_SIMILARITY_END              | [`--lowsim3sterm`](#options-alerts-lowsim3sterm) | - | - <a name="lowsim3s2"></a> | 
...
| [*lowsim5f*](#lowsim5f1)  | LOW_FEATURE_SIMILARITY_START    | [`--lowsim5fterm`](#options-alerts-lowsim5fterm) | all except CDS, mat_peptide and any feature with identical coordinates to a CDS or mat_peptide | - <a name="lowsim5f2"></a> | 
| [*lowsim3f*](#lowsim3f1)  | LOW_FEATURE_SIMILARITY_END      | [`--lowsim3fterm`](#options-alerts-lowsim3fterm) | all except CDS, mat_peptide and any feature with identical coordinates to a CDS or mat_peptide | - <a name="lowsim3f2"></a> | 
