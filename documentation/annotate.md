...
| `--lowsimterm <n>`  | [*lowsim5s*](#lowsim5s1), [*lowsim3s*](#lowsim3s1), [*lowsim5f*](#lowsim5f), [*lowsim3f*](#lowsim3f) | LOW_SIMILARITY_START, LOW_SIMILARITY_END, LOW_FEATURE_SIMILARITY_START, LOW_FEATURE_SIMILARITY_END | >= 15   | set length (nt) threshold for alert to `<n>` <a name="options-alerts-lowsimterm"></a> |
